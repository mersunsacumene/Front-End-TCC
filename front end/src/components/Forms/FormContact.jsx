      ...
      <form class="space-y-6" action="#" method="POST">    
       <div>
        ...
        <div>
          ...
          <div class="mt-2">
            <textarea rows="10"id="mensagem" name="mensagem" placeholder="Escreva sua mensagem" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-azul sm:text-sm sm:leading-6" />
          </div>
        </div>
